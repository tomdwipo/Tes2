...
import com.androbos.tes.BaseApplication;
import com.androbos.tes.Constant;
import com.androbos.tes.R;
import com.androbos.tes.helper.Utils;
import com.androbos.tes.json.Legs;
import com.androbos.tes.json.Steps;
import com.androbos.tes.model.LatLngModel;
...
public class ViewRouteActivity extends FragmentActivity {
    ...
    private com.androbos.tes.json.Response response;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (data.getInt("status") == MainUiActivity.FROM_LOCAL) {
            // baca db
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET,
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        response = new Gson().fromJson(jsonObject.toString(), com.androbos.tes.json.Response.class);
